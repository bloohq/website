...
Denna metod kallas [Kanban](/platform/features/kanban-board), vilket är ett japanskt tillverkningssystem som ursprungligen skapades av Toyota, där tillgången på de olika komponenterna och delarna som krävs för att bygga en bil övervakas genom att ha ett instruktionkort som skickas längs produktionslinjen.
