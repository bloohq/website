...
<iframe src="https://demo.arcade.software/oDtJdrmOjMMPdda020E9?embed" style="width:100%;height:450px"></iframe>
...
- [Triggers ("When")](/docs/automations/triggers): A trigger is an event that sets off an automation. For instance, a trigger could be the completion of a record, a change in a record's assignee, or a change in a custom field. When this predefined condition is met, the automation is activated.
- [Actions ("Then")](/docs/automations/actions): Once triggered, an automation performs a specific action. Actions can range from sending notifications and updating record fields to creating new tasks or changing the status of a record. Actions can be chained.

![Introduction 1](/public/docs/automation/introduction/Introduction_1.png "Introduction 1")
...
![Introduction 2](/public/docs/automation/introduction/Introduction_2.png "Introduction 2")
...
![Introduction 3](/public/docs/automation/introduction/Introduction_3.png "Introduction 3")
