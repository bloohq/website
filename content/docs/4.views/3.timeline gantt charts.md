...
The Timeline View visually displays [Dependencies](/docs/records/dependencies) set up across records (as seen in the above screenshot). This allows you to see how tasks relate and may impact other items.
