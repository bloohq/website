...
To ensure that the values on your stat cards are as relevant and targeted as possible, Blue offers robust filtering options — [any filter](/docs/views/filters) in any project view is available for use!
