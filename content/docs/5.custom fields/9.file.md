...
Uploaded files are shared project-wide under the ['Files' tab](/docs/projects/file-management). However, custom user roles with restricted record access will not see those files. The project Files tab supports folder creation to organise files, but files cannot be sorted into these folders from within the custom field itself.
