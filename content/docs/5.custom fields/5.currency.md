...
![Currency 1](/docs/customField/currency/Currency_1.png "Currency 1")
...
If your local currency is not supported, please contact <support@blue.cc>, and we will gladly implement it.
::

![Currency 2](/docs/customField/currency/Currency_2.png "Currency 2")
