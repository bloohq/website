...
The Email field seamlessly integrates with [Blue's Email Automation capabilities](/docs/automations/actions/email-automations). Email workflows can be triggered, and information from records can be merged into emails using the {merge} tag syntax.
