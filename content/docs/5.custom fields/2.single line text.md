...
You can leverage Blue's [advanced record filtering capabilities](/docs/views/filters) to find and filter records containing specific text within the Single Line Text field to locate matching records.
