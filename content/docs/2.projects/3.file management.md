...
description: Enjoy unlimited storage with up to 5GB per file.
---
...
![File Management 1](/public/docs/file_1.png "File Management 1")
...
Files uploaded in the description area of the records are not listed in the files tab, as these are typically used for temporary notes. We recommend uploading files to a [specific file custom field](/docs/custom-fields/file) instead.
::

## File Custom Field

Blue has a [specific custom file field for handling structured data uploads](/docs/custom-fields/file). Files uploaded in this field will show on the file tab in the project and can be deleted from both the custom field within the record and the files tab.

![File Management 2](/public/docs/file_2.png "File Management 2")
...
![File Management 3](/public/docs/file_3.gif "File Management 3")
...
![File Management 4](/public/docs/file_4.png "File Management 4")
...
![File Management 5](/public/docs/file_5.png "File Management 5")
...
![File Management 6](/public/docs/file_6.gif "File Management 6")
...
![File Management 7](/public/docs/file_7.png "File Management 7")
...
![File Management 8](/public/docs/file_8.png "File Management 8")
...
![File Management 9](/public/docs/file_9.png "File Management 9")
...
![File Management 10](/public/docs/file_10.png "File Management 10")

### Folders

#### Creating Folders

Folders are a valuable way to keep your file organised. [Project Administrators](/docs/user-management/roles/project-administrator) and [Team Members](/docs/user-management/roles/team-member) can create folders. You can create unlimited amounts of folders and sub-folders to match your organisational file structure.

You can create a folder by right-clicking on any empty space in the file tab.

![File Management 11](/public/docs/file_11.png "File Management 11")
...
![File Management 12](/public/docs/file_12.png "File Management 12")
...
![File Management 13](/public/docs/file_13.png "File Management 13")
...
![File Management 14](/public/docs/file_14.gif "File Management 14")
