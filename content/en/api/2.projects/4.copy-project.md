...
| `oldProject` | Project | The source project being copied |
| `newProjectName` | String | Name of the new project being created |
| `isTemplate` | Boolean | Whether this is copying as a template |
| `oldCompany` | Company | Source company |
| `newCompany` | Company | Target company |
