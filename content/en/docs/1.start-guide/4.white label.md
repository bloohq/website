...
The white-label add-on costs $50/month per company or $500/year per organization, in addition to your core Blue subscription. You can learn more about pricing [here](/pricing).

If you're interested in purchasing white label in bulk for multiple organizations, please contact sales@blue.cc
...
- [Forms](/docs/projects/forms) (optional)
- [File sharing links](/docs/projects/file-management) (optional)
...
This is the recommended configuration for the logo and favicon:

| Asset   | Recommended Shape | Background      | Aspect Ratio |
|---------|------------------|-----------------|-------------|
| Logo    | Rectangle        | Transparent     | 1:1.5       |
| Favicon | Square           | Transparent     | 1:1         |
...
The white label add-on costs $50/month/company or $500/year/company on top of your core Blue subscription. Bulk discounts will be available in the future for accounts with multiple companies.
...
For general help, you can contact support@blue.cc. For sales-related questions about custom mobile applications, contact sales@blue.cc.
