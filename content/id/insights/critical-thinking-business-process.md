...
2. **Proses pendukung**. Alur kerja sekunder ini tidak secara langsung berkontribusi pada keuntungan tetapi penting dalam mendorong bisnis. Misalnya, ini bisa berupa aktivitas SDM seperti mempertahankan penggajian karyawan atau melakukan prosedur orientasi yang efektif untuk staf baru.

3. **Proses manajemen**. Proses dan protokol ini mengawasi dan menilai operasi organisasi, dengan fokus pada kinerja dan kepatuhan. Mereka memastikan bahwa semua anggota perusahaan menangani tanggung jawab mereka dan bahwa semua fungsi bisnis berjalan dengan lancar.
