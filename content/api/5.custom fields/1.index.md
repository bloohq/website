...
- Field creation: 50 per hour per project
- Value updates: 1000 per minute
- Field queries: 2000 per minute
...
**For Simple Data:**
- `TEXT_SINGLE` - Short text values
- `TEXT_MULTI` - Long text descriptions
- `NUMBER` - Numeric values
- `CHECKBOX` - Yes/no flags

**For Calculated Values:**
- `FORMULA` - Automatic calculations based on other fields
- `PERCENT` - Percentage values
- `CURRENCY` - Monetary amounts
- `RATING` - Numeric ratings/scores

**For Controlled Choices:**
- `SELECT_SINGLE` - One choice from list
