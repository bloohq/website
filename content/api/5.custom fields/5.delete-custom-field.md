...
- **Field deletion**: 10 deletions per hour per project
- **Bulk operations**: Maximum 5 concurrent deletion requests
- **Webhook delivery**: Subject to standard webhook rate limits