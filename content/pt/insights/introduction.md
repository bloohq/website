---
title: Introdução
description: Aprenda por que escrevemos o guia definitivo sobre como administrar uma agência de forma eficaz e como começamos.
...
A única maneira de tomar decisões melhores é ter a estrutura adequada para a tomada de decisões. Isso deve ter fundamentos tanto em experiências (frequentemente conhecidas como erros!) quanto em [insights](/insights/insights).
...
Este livro analisa os últimos sete anos de experiências que tive gerenciando a [Mäd](https://mad.co), uma consultoria estratégica. Vou destacar princípios fundamentais que me ajudaram a superar minha falta inicial de conhecimento.
...
1. Gere um lucro confiável a cada ano.
2. Proporcione a todos um equilíbrio sensato entre trabalho e
tempo livre.
3. Crie uma cultura e um ambiente de trabalho dos quais você possa se orgulhar.
...
1. **Comece a Construir Momentum** — Como atrair negócios e estabelecer uma estratégia para garantir que você seja consistentemente abordado por novos clientes potenciais.
2. **Trabalhando com Humanos** — Como lidar tanto com membros da equipe quanto com clientes. Como tratar as pessoas como seres humanos com [ótima colaboração](/insights/great-teamwork), e não como engrenagens em uma máquina.
3. **Administre as Coisas de Forma Eficaz** — Uma vez que você tenha clientes e membros da equipe, como manter tudo funcionando bem e garantir que o negócio seja estável.
...
E assim, após esse segundo grande fracasso, decidi que tentaria fazer tudo. Assumi cada função funcional para entender o que precisava ser feito — e como fazê-lo. Queria entender tudo, desde finanças até [gerenciamento de projetos](/insights/project-management-basics-guide), vendas e marketing. Minha ideia era que assim que eu pudesse entender bem uma área funcional, poderia começar a delegá-la ou automatizá-la.

Embora um tanto estressante, isso foi educativo. Comecei a questionar por que certas coisas são feitas de maneiras específicas. Perguntei a mim mesmo, como posso simplificar radicalmente e até mesmo [automatizar processos críticos](/insights/applying-critical-thinking-to-process-design)?
...
À medida que o Blue começou a [ganhar recursos](/platform/changelog), esses foram testados em batalha pela Mäd. Isso deu início a um círculo virtuoso onde mais uso significava mais feedback. Isso, por sua vez, nos tornou mais reflexivos e organizados. O Blue agora tem milhares de organizações usando a plataforma em todo o mundo. Falarei mais sobre o Blue quando discutirmos [gerenciamento de projetos eficaz](/insights/effective-project-management).
...
Se você tiver alguma dúvida enquanto lê este livro, sinta-se à vontade para me enviar um e-mail para [manny@blue.cc](mailto:manny@blue.cc), e boa sorte!