...
1. Comptez votre temps de travail
2. Divisez par tous vos intervenants
3. Simple : vous donnez maintenant à chacun le temps dont il a besoin !
...
[Dans le Chapitre 4](/insights/nurturing-top-talent), j'ai discuté de l'analogie d'une entreprise comme une équipe sportive professionnelle (par opposition à une famille). Ici, le leader est l'entraîneur principal, avec la responsabilité clé de trouver et de développer les meilleurs talents tout en gardant un œil sur les non-performants.
