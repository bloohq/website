...
1. **Fournir de la clarté au client sur le projet proposé.** Vous pourriez trouver cela étrange si le client vous a contacté. Après tout, pourquoi devriez-vous lui expliquer le projet ? Eh bien, rappelez-vous que nous voulons nous positionner comme des experts. Vous avez réalisé plus de projets qu'eux, donc vous devriez être celui qui fournit la clarté.
2. **Éduquer le client sur pourquoi votre organisation a les meilleures personnes et l'expérience pour eux.** Pourquoi devraient-ils vous choisir plutôt qu'un autre ? Pourquoi votre société est-elle spécifiquement adaptée à leur secteur, leur problème et leur organisation ?
...
Et... vous avez besoin d'un [CRM facile à utiliser et performant](/solutions/use-case/sales-crm) (Gestion de la relation client) pour suivre toutes les propositions sur lesquelles vous travaillez !
...
1. Les éléments doivent aider à atteindre votre ou vos objectifs,
2. Ils doivent être convenus par le client et votre équipe au début du projet,
3. Ils doivent être réalisés par un travail significatif, et
4. Ils doivent, bien sûr, être dans le périmètre de travail défini depuis le début du projet.
