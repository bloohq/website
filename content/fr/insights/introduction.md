---
title: Introduction
description: Découvrez pourquoi nous avons écrit le guide définitif sur la façon de gérer une agence efficacement, et comment nous avons commencé.
...
La seule façon de faire de meilleurs choix est d'avoir le cadre approprié pour la prise de décision. Cela doit avoir des fondations dans les expériences (souvent connues sous le nom d'erreurs !) et des [aperçus](/insights/insights).

Si vous pouvez apprendre des erreurs des autres, c'est souvent mieux que de faire les vôtres — d'où ce livre.

Ce livre analyse les sept dernières années d'expériences que j'ai eues en dirigeant [Mäd](https://mad.co), un cabinet de conseil stratégique. Je vais extraire des principes fondamentaux qui m'ont aidé à surmonter mon manque initial de connaissances.
...
1. Réalise un bénéfice fiable chaque année.
2. Offre à chacun un équilibre raisonnable entre travail et temps libre.
3. Crée une culture et un environnement de travail dont vous pouvez être fier.
...
1. **Commencer à Créer de l'Élan** — Comment attirer des affaires et définir une stratégie pour vous assurer que vous êtes constamment approché par de nouveaux clients potentiels.
2. **Travailler avec des Humains** — Comment gérer à la fois les membres de l'équipe et les clients. Comment traiter les gens comme des êtres humains avec [un excellent travail d'équipe](/insights/great-teamwork), et non comme des rouages dans une machine.
3. **Gérer les Choses Efficacement** — Une fois que vous avez des clients et des membres d'équipe, comment garder tout en marche harmonieusement et garantir que l'entreprise est stable.
...
Et donc, après ce deuxième grand échec, j'ai décidé que j'allais essayer de tout faire. J'ai pris chaque rôle fonctionnel pour comprendre ce qui devait être fait — et comment le faire. Je voulais comprendre tout, des finances à la [gestion de projet](/insights/project-management-basics-guide) en passant par les ventes et le marketing. Mon idée était qu'aussitôt que je pouvais comprendre un domaine fonctionnel correctement, je pouvais commencer à le déléguer ou à l'automatiser.

Bien que quelque peu stressant, cela a été éducatif. J'ai commencé à me demander pourquoi certaines choses sont faites de certaines manières. Je me suis demandé, comment puis-je radicalement simplifier et même [automatiser des processus critiques](/insights/applying-critical-thinking-to-process-design) ?
...
Alors que Blue commençait à [gagner des fonctionnalités](/platform/changelog), celles-ci étaient testées au combat par Mäd. Cela a déclenché un cercle vertueux où plus d'utilisation signifiait plus de retours. Cela, à son tour, nous a rendus plus réfléchis et organisés. Blue a maintenant des milliers d'organisations utilisant la plateforme à travers le monde. Je parlerai davantage de Blue lorsque nous discuterons de [la gestion de projet efficace](/insights/effective-project-management).
...
Si vous avez des questions en lisant ce livre, n'hésitez pas à m'envoyer un email à [manny@blue.cc](mailto:manny@blue.cc), et bonne chance !