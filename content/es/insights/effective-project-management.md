...
---
Como un apunte, una de las principales [razones por las que comencé Blue](/insights/why-i-started-blue) fue porque tenía un fuerte deseo de mejorar en la gestión de mis proyectos. Intenté usar varias otras herramientas, pero simplemente no funcionaron para mí, y por eso comencé [Blue](/).
...
Este método se llama [Kanban](/platform/features/kanban-board), que es un sistema de fabricación japonés creado originalmente por Toyota, donde el suministro de los diversos componentes y piezas requeridos para construir un automóvil se monitorea mediante una tarjeta de instrucciones que se envía a lo largo de la línea de producción.
