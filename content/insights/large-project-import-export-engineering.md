...
- **[Dashboard/Charts](/platform/features/dashboards)**: Processes large datasets in the background to generate up-to-date visualizations without slowing down the user interface.
